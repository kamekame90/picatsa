  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Ajout d'une nouvelle vignette</h3>
      </div>
      @if (session('stored'))
        {{ session('stored') }}
      @endif
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_content">
            ...
            <form  action="{{ route('vignettes.store') }}" method="POST" id="form1" data-parsley-validate class="form-horizontal form-label-left">
              @csrf
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="travel-label">Legende<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input name="legende" type="text" id="travel-label" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" name="url" id="date-begin" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
